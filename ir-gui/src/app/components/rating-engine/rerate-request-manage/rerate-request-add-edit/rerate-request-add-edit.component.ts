...
import { ReRateRequestDTO, ReRateRequestService, CdrQueryConfigDTO } from '../rerate-request.service';

@Component({
  selector: 'app-rerate-request-add-edit',
  templateUrl: './rerate-request-add-edit.component.html',
  standalone: false,
  styleUrls: []
})
export class ReRateRequestAddEditComponent implements OnInit, OnDestroy {
  form!: FormGroup;
  ...
  submit(): void {
    ...
    const payload: ReRateRequestDTO = {
      ...v,
