...
@SQLDelete(sql = "UPDATE voice_rated_cdr SET is_deleted = true, deleted_at = NOW() WHERE rated_cdr_id = ?")
@Where(clause = "is_deleted = false")
public class VoiceRatedCdr extends BaseEntity implements RateableCdr {
    ...
    /** Call event start — stored as proper datetime for correct billing date bucketing. */
    ...
    public BigDecimal getDurationForRating() {
        return durationSeconds != null ? BigDecimal.valueOf(durationSeconds) : BigDecimal.ZERO;
    }
